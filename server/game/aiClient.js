...
export async function getAiVerdict(jobDescription, humanResume) {
  ...
  const prompt =
    ...
    `Respond ONLY as JSON in this exact shape: {"decision": "hire" | "automate", "reasoning": "1-2 concise sentences IN VIETNAMESE"}`;
